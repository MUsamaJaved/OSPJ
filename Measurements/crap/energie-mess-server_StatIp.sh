...
wh=`snmpget -c public -v 1 192.168.4.8 1.3.6.1.4.1.28507.2.1.3.1.3.$channel | cut -b54-`
...
while sleep $interval; do
	...
	w=`snmpget -c public -v 1 192.168.4.8 1.3.6.1.4.1.28507.2.1.3.1.4.$channel | cut -b54-`
